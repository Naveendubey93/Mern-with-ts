...
import listTanantsValidator from '../validators/list-tenants.validators';
...
router.get('/', listTanantsValidator, (req: Request, res: Response, next: NextFunction) => tenantController.findAll(req, res, next));
